...
impl PubSubDb {
    ...
    pub fn new() -> PubSubDb {
        ...
        let (client_to_game_sender, client_to_game_receiver) = unbounded::<Msg<String>>();
...
#[derive(Debug)]
pub struct State {
    pub client_to_game_sender: crossbeam_channel::Sender<Msg<String>>,
    pub client_to_game_receiver: crossbeam_channel::Receiver<Msg<String>>,
    pub clients: HashMap<Channel, tokio::sync::mpsc::Sender<Msg<String>>>,
}
//
// #[cfg(test)]
// mod tests {
